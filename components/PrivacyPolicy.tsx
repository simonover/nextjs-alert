...
const PrivacyPolicy: React.FC = () => {
  return (
    <div>
      <h1 className='text-4xl mt-5 mb-4'>Privacy Policy</h1>
      ...
      <h1 className='text-4xl mt-5 mb-4'>Interpretation and Definitions</h1>
      <h2 className='text-2xl mt-4 mb-3'>Interpretation</h2>
      <p>
      ...
      <h2 className='text-2xl mt-4 mb-3'>Definitions</h2>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Alert.rip , 21 Woodbank drive .
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to alert.rip, accessible from{' '}
            <Link
              href='http://www.alert.rip'
      ...
      <h1 className='text-4xl mt-5 mb-4'>
        Collecting and Using Your Personal Data
      </h1>
      <h2 className='text-2xl mt-4 mb-3'>Types of Data Collected</h2>
      <h3 className='text-xl mt-3 mb-2'>Personal Data</h3>
      <p>
      ...
      <h3 className='text-xl mt-3 mb-2'>Usage Data</h3>
      ...
      <h2 className='text-2xl mt-4 mb-3'>Use of Your Personal Data</h2>
      ...
      <h2 className='text-2xl mt-4 mb-3'>Transfer of Your Personal Data</h2>
      <p>
      ...
      <h2 className='text-2xl mt-4 mb-3'>Disclosure of Your Personal Data</h2>
      <h3 className='text-xl mt-3 mb-2'>Business Transactions</h3>
      <p>
      ...
      <h3 className='text-xl mt-3 mb-2'>Law enforcement</h3>
      <p>
      ...
      <h2 className='text-2xl mt-4 mb-3'>Security of Your Personal Data</h2>
      <p>
      ...
      <h1 className='text-4xl mt-5 mb-4'>{`Children's Privacy`}</h1>
      <p>
      ...
      <ul>
        <li>By mail: 20 Woodbank Drive, Dublin, Ireland</li>
      </ul>
    </div>
  )
}
